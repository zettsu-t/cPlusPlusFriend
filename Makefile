...
clean:
	$(RM) $(TARGETS) $(EXTERNAL_TARGETS) $(OBJS) $(OBJS_NO_OPT) $(OBJS_GCC_LTO) $(BCS_OBJS) $(OUTPUT_ASMS) $(OUTPUT_GENERATED_HEADER) $(OUTPUT_FUNCLIST) $(OUTPUT_FUNCLIST_TEMPS) $(OUTPUT_LOGS) ./*.o ./*.bc ./*.s
