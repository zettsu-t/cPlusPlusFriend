...
元素記号でしりとり(大文字と小文字は区別しない)をして、長さを競うというものです。現在元素記号がついている118元素では、[79が最長](https://twitter.com/gensogaku/status/1372905050297696257)だそうです。

[最長しりとりを探すスクリプト](scripts/stock_price/elements.R)と、[最長しりとりを表示するスクリプト](scripts/stock_price/elements_drawing.R)を置きました。ランダムでも78が見つかるので、もっと賢いアルゴリズムがあると思います。
